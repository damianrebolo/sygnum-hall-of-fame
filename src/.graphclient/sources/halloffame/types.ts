...
export namespace HalloffameTypes {
...
export type _SubgraphErrorPolicy_ =
  ...
  /** null **/
  userToken: InContextSdkMethod<Query['userToken'], QueryuserTokenArgs, MeshContext>,
  /** null **/
  userTokens: InContextSdkMethod<Query['userTokens'], QueryuserTokensArgs, MeshContext>,
  /** null **/
  ...
  /** null **/
  userToken: InContextSdkMethod<Subscription['userToken'], SubscriptionuserTokenArgs, MeshContext>,
  /** null **/
  userTokens: InContextSdkMethod<Subscription['userTokens'], SubscriptionuserTokensArgs, MeshContext>,
  /** null **/
  ...
  export type Context = {
      ["halloffame"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
